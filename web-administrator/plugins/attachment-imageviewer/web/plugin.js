...
function register(platform2) {
  function ImageViewer({ attachment, channelId, messageId, platform: platform3 }) {
    ...
    if (state.status === "error") {
      return /* @__PURE__ */ React.createElement("div", { className: "mt-[13px]" }, /* @__PURE__ */ React.createElement("div", { className: "text-text-faint" }, `Could not load image: ${state.message}`));
    }
