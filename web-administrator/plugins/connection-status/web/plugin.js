...
function register(platform2) {
  ...
  function ConnectionLogTab({ selection }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "dt-wrap h-full" }, /* @__PURE__ */ React.createElement("table", { className: "dt" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { className: "sortable", style: { cursor: "pointer" }, onClick: () => toggleSort("logId") }, "Id", /* @__PURE__ */ React.createElement("span", { className: "sort-arrow" }, arrow("logId"))), /* @__PURE__ */ React.createElement("th", { className: "sortable", style: { cursor: "pointer" }, onClick: () => toggleSort("dateAdded") }, "Timestamp", /* @__PURE__ */ React.createElement("span", { className: "sort-arrow" }, arrow("dateAdded"))), /* @__PURE__ */ React.createElement("th", { className: "sortable", style: { cursor: "pointer" }, onClick: () => toggleSort("channelName") }, "Channel", /* @__PURE__ */ React.createElement("span", { className: "sort-arrow" }, arrow("channelName"))), /* @__PURE__ */ React.createElement("th", { className: "sortable", style: { cursor: "pointer" }, onClick: () => toggleSort("connectorType") }, "Connector", /* @__PURE__ */ React.createElement("span", { className: "sort-arrow" }, arrow("connectorType"))), /* @__PURE__ */ React.createElement("th", { className: "sortable", style: { cursor: "pointer" }, onClick: () => toggleSort("eventState") }, "Event", /* @__PURE__ */ React.createElement("span", { className: "sort-arrow" }, arrow("eventState"))), /* @__PURE__ */ React.createElement("th", { className: "sortable", style: { cursor: "pointer" }, onClick: () => toggleSort("information") }, "Information", /* @__PURE__ */ React.createElement("span", { className: "sort-arrow" }, arrow("information"))))), /* @__PURE__ */ React.createElement("tbody", null, sorted.map((item, i) => /* @__PURE__ */ React.createElement("tr", { key: item.logId != null ? `log-${item.logId}` : `row-${i}` }, /* @__PURE__ */ React.createElement("td", { className: "mono" }, fmtNumber(item.logId)), /* @__PURE__ */ React.createElement("td", { className: "mono" }, String(item.dateAdded ?? "")), /* @__PURE__ */ React.createElement("td", null, String(item.channelName ?? "")), /* @__PURE__ */ React.createElement("td", null, String(item.connectorType ?? "")), /* @__PURE__ */ React.createElement("td", null, StateCell(String(item.eventState ?? ""))), /* @__PURE__ */ React.createElement("td", { className: "mono" }, String(item.information ?? ""))))), !items.length && /* @__PURE__ */ React.createElement("caption", { className: "[caption-side:bottom] p-3.5 text-text-faint" }, error ? `Connection log unavailable: ${error}` : lastError ? `Connection log unavailable: ${lastError}` : "No connection events yet.")));
  }
