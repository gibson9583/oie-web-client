 ...
 */
export function checkImportVersionForElements(
    elements: ArrayLike<Element> | null | undefined, objectName?: string
): ImportVerdict {
    return checkImportVersionForValues(
        Array.from(elements || []).map((el) => el.getAttribute('version')), objectName);
}
 ...
 */
export function checkImportVersionForValues(
    versions: Array<string | null | undefined>, objectName?: string
): ImportVerdict {
