 ...
 *
 * <base> comes from core/websupport.ts: '' on an engine that ships the endpoints
...
function flattenProps(props: OieObject | null | undefined): string {
 ...
 */
export async function serializeTemplate(dataType: string, serializationProperties: OieObject | null | undefined, message: unknown): Promise<SerializedTemplate | null> {
    try {
 ...
 */
export async function formatScript(script: string | null | undefined): Promise<string | null> {
    try {
