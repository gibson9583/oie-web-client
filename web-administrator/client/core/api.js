...
function setReachable(next) {
    ...
    for (const fn of connectionListeners.slice()) {
        ...
        catch { /* a bad listener must not break the request */ }
    }
}
/*
...
/* ---- Status & statistics --------------------------------------------------- */
export const status = {
    list: (channelIds, filter, includeUndeployed) => get('/channels/statuses', { channelId: channelIds, filter, includeUndeployed })
...
export const statistics = {
    ...
    clear: (channelIdsToConnectors, received = true, filtered = true, sent = true, errored = true) => {
        ...
        return postXml('/channels/_clearStatistics', `<map>${entries.join('')}</map>`, { received, filtered, sent, error: errored });
    },
