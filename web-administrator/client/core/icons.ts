...
const P: Record<string, string> = {
    ...
    // Adjustment sliders: three tracks with offset handles. Customize used to share
    // the gear with Settings, which read as two ways into the same place.
    sliders: 'M6 3v18M12 3v18M18 3v18M3.5 8h5M9.5 14h5M15.5 10h5',
    // Month grid with the two hanging tabs — the date fields' trigger.
    calendar: 'M4 6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2zM4 9h16M9 3v3M15 3v3',
    ...
    menuOpen: 'M4 6h12M4 12h12M4 18h12M20 7l-4 5 4 5',
...
export function icon(name: string, size: number = 16): SVGElement {
...
export function iconPath(name: string): string { return P[name] || P.info; }
