...
import {
    ConnectorForm, PollSection, ConnectorTestButton as TestButton, asBool, YES_NO,
        ...
        return (
            <div>
                ...
                <div style={{ marginTop: '10px' }}>
                    <TestButton label="Test Read" icon="folder" path="/connectors/file/_testRead" channel={channel} properties={properties} />
                </div>
            </div>
        );
    }
    ...
    component({ properties, channel, onChange }) {
        ...
        return (
            <div>
                ...
                <div style={{ marginTop: '10px' }}>
                    <TestButton label="Test Write" icon="folder" path="/connectors/file/_testWrite" channel={channel} properties={properties} />
                </div>
            </div>
        );
    }
