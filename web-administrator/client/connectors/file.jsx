    ...
    return [
        ...
        { section: 'Amazon S3 Settings', visible: s3 },
        {
            ...
            append: (p) => asBool(p.anonymous)
                ? h('span', { style: { color: '#c0392b', marginLeft: '12px', fontWeight: '500' } }, 'Anonymous credentials are currently in use')
                : null,
    ...
    return {
        ...
        render: (p) => {
            ...
            function paint() {
                ...
                const listBox = h('div', {
                    style: {
                        gridColumn: '3', gridRow: `1 / ${rows.length + 1}`, alignSelf: 'stretch',
                        border: '1px solid var(--line)', borderRadius: '4px', padding: '4px 0',
                        minWidth: '150px', background: 'var(--bg1)', overflow: 'auto'
                    }
