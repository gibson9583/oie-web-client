...
import { ConnectorForm, portsInUseButton, listenerAddressField, asBool, YES_NO, defaultSourceProperties, defaultDestinationProperties, defaultListenerProperties, requireFields } from './react-forms.js';
const TLS_OPTIONS = [
    ...
    component({ properties, onChange }) {
        return (React.createElement(ConnectorForm, { properties: properties, onChange: onChange, fields: [
                ...
                },
                {
                    ...
                    disabled: transferSyntaxLocked,
                    onSet: (p) => { if (asBool(p.nativeData))
                        p.defts = false; }
                },
