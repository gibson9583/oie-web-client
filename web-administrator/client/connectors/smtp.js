...
import { buildForm, connectorTestButton, asBool, YES_NO, defaultDestinationProperties, CHARSETS } from './forms.js';
...
const smtpSender = {
    ...
    render(host, { properties, channel, onChange }) {
        ...
        host.appendChild(h('div', { style: { marginTop: '10px' } },
            connectorTestButton({ label: 'Send Test Email', icon: 'mail', path: '/connectors/smtp/_sendTestEmail', channel, properties })));
    }
};
