...
export declare const FONT_UI_OPTIONS: string[];
export declare const FONT_MONO_OPTIONS: string[];
export declare function setFontUi(font: string): void;
export declare function setFontMono(font: string): void;
