...
export function channelWithSourceElement(id: any, kind: any, classKey: any, element: any) {
...
const base = (extra: any) => ({ '@version': V, name: 'Original', sequenceNumber: '0', enabled: true, ...extra });
